...
namespace QuanLyBenhVien.DAL
{
    class BenhVienDAO
    {
        ...
        public bool Insert(BenhVienDTO bv)
        {
            ...
            String query1 = "Select count (MaYTe) from BenhNhan where MaYTe= @MaYTe";
            SqlCommand cmd1 = new SqlCommand(query1, con);
            cmd1.Parameters.Add(new SqlParameter("@MaYTe", bv.MaYTe));
        ...
        public bool Delete(BenhVienDTO bv)
        {
            ...
            SqlConnection con = new SqlConnection(connect);
            con.Open();
            String query = "DELETE FROM LichSuKhamBenh WHERE MaYTe = @MaYTe;DELETE FROM BenhNhan WHERE MaYTe = @MaYTe;";
            SqlCommand cmd = new SqlCommand(query, con);
            cmd.Parameters.Add(new SqlParameter("@MaYTe", bv.MaYTe));
            int rows = cmd.ExecuteNonQuery();
            if (rows > 0) result = true;
